...
icon = pygame.image.load('images/pacman_right.png')
pygame.display.set_icon(icon)

pygame.mixer.init()
pygame.mixer.music.load('pacman_music.mp3')
...
def startGame():
    ...
    Pacman = Player(w, p_h, "images/pacman_right.png")
...
def doNext(message, left, all_sprites_list, block_list, monsta_list, pacman_collide, wall_list, gate):
    while True:
        ...
        text2 = font.render("    Заново - нажмите ENTER.", True, white)
        screen.blit(text2, [135, 303])
        text3 = font.render("Выйти - нажмите ESCAPE.", True, white)
